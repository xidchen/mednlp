...
"""
intelligence_classify_cnn_model.py
...
from mednlp.text.vector import Word2vector, StandardAsk2Vector
from ailib.model.base_model import BaseModel
from keras.preprocessing.sequence import pad_sequences


class InterlligenceClassifyCNN(BaseModel):
...
if __name__ == '__main__':
    cnn_model = InterlligenceClassifyCNN(cfg_path=global_conf.cfg_path, model_section='DEPT_CLASSIFY_TEXTCNN_MODEL')
