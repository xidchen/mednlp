...
from mednlp.text.neg_filter import filter_negative, filter_physical_examination_negative
...
class AidDiagnose(object):
    ...
    def diagnose(self, medical_record, **kwargs):
        ...
        medical_record['inspection'] = filter_negative(medical_record['inspection'])
        medical_record['physical_examination'] = filter_negative(medical_record['physical_examination'])
        ...
        if medical_entity == '':
            ...
            self.physical_exam_filter(
                disease_pop, filter_physical_examination_negative(
...
#       "value": [
#         {
#           "content": "恶心、呕吐、停止排气、停止排便等肠梗阻征象"
#         },
#         {
#           "content": "持续的严重腹痛（不能进行正常生活和工作）"
#         }
#       ],
#       "answer": [
#         "恶心、呕吐、停止排气、停止排便等肠梗阻征象",
#         "持续的严重腹痛（不能进行正常生活和工作）"
#       ],
#       "unit": ""
#     }
...
#     rd = RuleDiagnose()
#     print(rd.optimize_diagnose(arguments, []))
